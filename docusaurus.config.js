        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'Discord',
                href: 'https://discord.com/invite/JHxMj9EQbA',
              },
              {
                label: 'Twitter',
                href: 'https://twitter.com/realwasmedge?lang=en',
              },
            ],
          },
        ],
        copyright: `Copyright © ${new Date().getFullYear()} WasmEdge, Inc. Built with Docusaurus.`,
      },
      prism: {
